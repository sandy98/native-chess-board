...
export const asciiHorzLine = `${'+---'.repeat(8)}+\n`;
export const asciiVertline = `${'| . '.repeat(8)}|\n`;
export const asciiRow = `${asciiHorzLine}${asciiVertline}`;
export const asciiBoard = `${asciiRow.repeat(8)}${asciiHorzLine}`
...
export const blackFigures = ["r","n","b","q","k","p"];
export const whiteFigures = ["R","N","B","Q","K", "P"];
...
export const square2san = index => {
    const rowcol = index2rowcol(index);
    return rowcol2name(rowcol.row, rowcol.col);
}
export const san2square = san => (san.charCodeAt(0) - 97) + ((san.charCodeAt(1) - 49) * 8);
export const rowFromIndex = index => Math.floor(index / 8)
export const colFromIndex = index => index % 8
export const index2rowcol = index => ({ row: rowFromIndex(index), col: colFromIndex(index)})
export const rowcol2index = (row, col) => row * 8 + col
export const colLetterFromIndex = index => String.fromCharCode(colFromIndex(index) + 97)
export const rowNumberFromIndex = index => `${rowFromIndex(index) + 1}`

export const isDarkSquare = index => {
...
export class FakeValidator extends ChessValidator {
