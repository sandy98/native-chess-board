const versionInfo = {major: 1, minor: 5, release: 3};
...
const assortedFens = {
    ...
    frenchFen: 'rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2',
    sicilianFen: 'rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2',
    caroKanFen: 'rnbqkbnr/pp1ppppp/2p5/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2',
    smotheredFen: '4k3/4P3/3K4/8/8/8/8/8 w - - 1 50',
    helpedMateFen: 'r1bqkbnr/pppnpppp/7P/3p4/8/8/PPPPPPP1/RNBQKBNR b KQkq - 0 3',
    KnightandBishopFen: '4k3/8/8/8/8/8/8/N3K2B w - - 0 1',
    mateIn3Fen: '3krn2/p1p1p3/3n4/2N2b1q/Q7/6p1/4P1P1/1R4K1 w - - 0 1',
}

const defaultFen = assortedFens.defaultFen;
const emptyFen = assortedFens.emptyFen;
...
export {
    versionInfo, version, genRange, range, unicodeFigures, onePixel, classicSet, asciiHorzLine, asciiVertline, asciiRow, asciiBoard,
    ...
    defaultFen, emptyFen, assortedFens, evergreen_json, evergreen_pgn, inmortal_json, inmortal_pgn, 
